    ...
    $.extend(Tool.prototype, {
        ...
        getTemplate: function () {
            ...
            var temLi1 = $('.js-li-box').find('li').eq(0);
            var temLi2 = $('.js-li-box').find('li').eq(1);
            var temLi3 = $('.js-li-box').find('li').eq(2);
            var temTab1 = $('.js-tab-box').children().eq(0);
            var temTab2 = $('.js-tab-box').children().eq(1);
            var temTab3 = $('.js-tab-box').children().eq(2);
