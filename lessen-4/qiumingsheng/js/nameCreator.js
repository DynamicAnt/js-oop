...
TemplateFactory = (function(){
    ...
    return {
        creator:function(name){
            ...
            var $panel = $panelList.eq(LIBS[name].panelIndex);
            $('.js-tab li').eq(LIBS[name].panelIndex).attr('active','1').show();
...
$.extend(NameCreator.prototype, {
    ...
    initElement: function(){
        this.$panelList = $('.js-node').children();
        $('.js-tab li').hide();
    },
    ...
    initEvent: function(){
        var _this = this;
        $('.js-tab li[active=1]').each(function(i){
        ...
        $('.js-btnreset').click(function(){
            ...
            $('.js-tab li[active=1]').eq(0).trigger('click');
