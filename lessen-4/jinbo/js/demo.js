    ...
    $.extend(Tool.prototype, {
        ...
        getTemplate: function () {
            var tabLength = $('.js-node').children().length;
            var $listNode = $('.js-node').children();
            switch (tabLength){
                case 1:
                    var template1 = new Template3($listNode.eq(0));
                    this.templateArr = [template1];
                    break;
                case 2:
                    var template1 = new Template1($listNode.eq(0))
                    var template2 = new Template2($listNode.eq(1))
                    this.templateArr = [template1, template2];
                    break;
                case 3:
                    var template1 = new Template1($listNode.eq(0))
                    var template2 = new Template2($listNode.eq(1))
                    var template3 = new Template3($listNode.eq(2))
        ...
        initEvent: function () {
            ...
            $('.js-tab li').each(function(i){
                $(this).on('click',function(){
                    _self.chooseTab(i);
                    _self.tabIndex = i
                    _self.templateArr[i].updateScoreView();
                });
            });
        },
        btnEvent: function () {
            ...
            $('.js-btn-submit').click(function(){
                ...
                console.log(_self.templateArr[_self.tabIndex]);
            })
            //点击取消按钮
